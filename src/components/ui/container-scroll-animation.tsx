...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-fit flex items-center justify-center relative p-2 md:p-8 overflow-hidden"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl md:-mt-12 mx-auto h-[30rem] md:h-[35rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl will-change-transform"
    >
