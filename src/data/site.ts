...
export const products: Product[] = [
  ...
  { id: "10", name: "Lançamento Noir", brand: "New Collection", category: "grau", style: "moderno", img: new1, description: "Elegância em preto fosco para um visual contemporâneo." },
  { id: "11", name: "Destaque Gold", brand: "New Collection", category: "grau", style: "luxo", img: new2, description: "Detalhes dourados que elevam qualquer look." },
  { id: "12", name: "Minimal Silver", brand: "New Collection", category: "grau", style: "minimalista", img: new3, description: "Simplicidade e sofisticação em metal prateado." },
  { id: "13", name: "Vintage Tortoise", brand: "New Collection", category: "grau", style: "vintage", img: new4, description: "O clássico tartaruga revisitado com design moderno." },
  { id: "14", name: "Arctic Clear", brand: "New Collection", category: "grau", style: "minimalista", img: new5, description: "Transparência total para quem busca leveza absoluta." },
];
